(function () {
    ...
    angular.module('mail.controller', [])
            .controller('MailCtrl', ['$scope', '$filter', '$modal', '$state', '$stateParams', 'Mails',
                function ($scope, $filter, $modal, $state, $stateParams, Mails) {
                    ...
                    $scope.composeEmail = function (mail) {
                        ...
                        var modalInstance = $modal.open({
                            ...
                            controller: function ($scope, $modalInstance, contacts, email) {
