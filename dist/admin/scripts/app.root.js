(function () {
    ...
    angular.module('app')
            .controller('RootCtrl', ['$scope', '$rootScope', '$localStorage', '$timeout', '$translate', 'Fullscreen','$q',
                function ($scope, $rootScope, $localStorage, $timeout, $translate, Fullscreen,$q) {
                    ...
                    $rootScope.getDummyPromise = function(){
                        ...
                        $timeout(function() {defer.resolve({})}, 3000);
